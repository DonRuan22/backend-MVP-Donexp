...
router.post('/search', async (req, res) => {
    ...
    */
    ...
    let products = await conn.request()
                            ...
                            .query("SELECT products.title, products.price, products.quantity, products.description, products.image, products.id, products.short_desc, products.cat, products.brand, products.sizes, products.color FROM products WHERE products.title = CASE WHEN @productModel !='' THEN @productModel ELSE products.title END");
